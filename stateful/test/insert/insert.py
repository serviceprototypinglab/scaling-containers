...
@app.get('/test/selects/<tenant_start>/<tenant_end>/<option>/<replica>/<loop>/<lim>/<word>')
def test_selects(tenant_start, tenant_end, option, replica, loop, lim, word):
    host_name = '35.184.62.148'
    if option == 'D':
